 ...
 *
 * */
const _string = "chiMinke" ;
const _stairngChinese = '地球您好';
...
for ( let i = 0 ; i < _stairngChinese.length ;i++){
    console.log(_stairngChinese[i]); // 地 球 您 好
} ;
for (let i of _string){  //能够遍历 unicode大于 0xffff转换过来的字符
    console.log(i); // c h i ...
} ;
const _text = String.fromCodePoint(  0x20bb7) ; // 吉
for (let i of _text){
    console.log(i) ; // 吉
} ;
/*==========================================*/
