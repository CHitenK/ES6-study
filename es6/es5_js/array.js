...
var arr4 = Array.from(obj, function (x, index) {
  // x = > value  index => 下标
  console.log(index);
  if (!x) {
...
console.log(arr7);
var findIndex = arr7.find(function (n) {
  return n > 8;
});
...
try {
  for (var _iterator = _arr3.entries()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
try {
  for (var _iterator2 = _arr3.keys()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
